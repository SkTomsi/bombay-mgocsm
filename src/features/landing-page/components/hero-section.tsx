...
export function Hero() {
  return (
    <div className="flex flex-col items-center justify-items-center gap-4 relative  w-full text-center pb-10 md:pb-30 pt-4 md:pt-0">
      ...
      <div className="relative flex flex-col items-center justify-center w-full   px-5 md:pt-20 pt-32">
        ...
        <motion.div
          className="my-20  bg-primary-light/20 md:mx-20 lg:mx-40 max-lg:w-full p-2 rounded-xl md:rounded-3xl border-dashed border-brand-yellow/40 border-2 shadow-2xl"
